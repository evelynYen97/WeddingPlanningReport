...
namespace WeddingPlanningReport.Controllers
{
    public class BudgetChartsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BudgetChartId,MemberId,ChartType,ChartName,ChartUnit,RentDetailId,MenuDetailId,CakeDetailId,VenueId")] BudgetChart budgetChart)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BudgetChartId,MemberId,ChartType,ChartName,ChartUnit,RentDetailId,MenuDetailId,CakeDetailId,VenueId")] BudgetChart budgetChart)
        {
